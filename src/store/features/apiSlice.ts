...
export const apiSlice = createApi({
  ...
  endpoints: (builder) => ({
    ...
    // Create book
    createBook: builder.mutation<any, { title: string; author: string; publisher?: string; bookCount?: number; accessionNumbers?: string[]; rackNumber?: string; stock?: number }>({
      query: (body) => ({
        url: '/books',
        method: 'POST',
        body,
    ...
    // Update book
    updateBook: builder.mutation<any, { id: number; title: string; author: string; publisher?: string; bookCount?: number; accessionNumbers?: string[]; rackNumber?: string; stock?: number }>({
      query: ({ id, ...body }) => ({
        url: `/books/${id}`,
        method: 'PUT',
        body,
    ...
    // Bulk Delete books
    deleteBulkBooks: builder.mutation<any, number[]>({
      query: (ids) => ({
